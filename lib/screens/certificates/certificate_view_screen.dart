...
//
//           // ✅ window.print() intercept
//           window.print = function() {
//             CertDownloader.postMessage('PRINT_REQUESTED');
//           };
//
...
//             }
//
//             // ✅ Case 2: regular link with download attribute
...
//     // ✅ Print request — Chrome मध्ये open करा
//     if (message.message == 'PRINT_REQUESTED') {
//       await launchUrl(
//         Uri.parse(widget.cert.certificateUrl),
