...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Form(
          key: _formKey,
          child: _buildPortrait(hp),
        ),
      ),
    );
  }

  Widget _buildPortrait(double hp) => SingleChildScrollView(
    child: Column(
      ...
      children: [
        ...
        _buildFieldsCard(hp),
        const SizedBox(height: 24),
        _buildSubmitButton(hp),
        _buildCancelButton(hp),
  ...
  Widget _buildFieldsCard(double hp) {
              ...
              Expanded(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(
                        fontSize: 12,
                        color: AppColors.text2Of(context).withOpacity(0.6)),
  ...
  Widget _buildSubmitButton(double hp) => Padding(
  ...
  Widget _buildCancelButton(double hp) => Padding(
